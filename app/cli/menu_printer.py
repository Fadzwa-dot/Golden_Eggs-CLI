...
class MenuPrinter:
    ...
    def print_menu(self, title: str, options: Iterable[str]) -> None:
        """
        ...
        for idx, opt in enumerate(options, start=1):
            table.add_row(f"[cyan]{idx}.[/cyan]", str(opt))
    ...
    def prompt_choice(self, max_choice: int, prompt_text: str = "Select option") -> int:
        ...
        while True:
            try:
                ...
                self.console.print("\n[red]Input cancelled. Returning to the previous menu.[/red]")
                return 0
    ...
    def run(self) -> None:
        ...
        """
        while True:
            self.print_menu("Login Menu", ["Login", "Exit"])
            ...
            if choice == 1:
                ...
                if auth_ok:
                    ...
                    self.console.print("[red]Authentication failed. Please check your credentials and try again.[/red]")
    ...
    def _manage_users_menu(self) -> None:
        ...
        while True:
            self.print_menu("Manage Users", ["View Users", "Add User", "Delete User", "Deposit Money", "Back to Main Menu"])
    ...
    def _view_users(self) -> None:
        ...
        try:
            ...
            if not users:
                self.console.print("[yellow]No users found in the system. Please add users to proceed.[/yellow]")
                return
            ...
            self.console.print(f"[red]Error occurred while fetching user details. Please try again later.[/red]")
    ...
    def _add_user(self) -> None:
        ...
        try:
            ...
            if new_user:
                ...
                self.console.print("[red]Failed to add user. Ensure all fields are correctly filled and try again.[/red]")
        except Exception as e:
            self.console.print(f"[red]Error occurred while adding the user. Please contact support.[/red]")
    ...
    def _deposit_money(self) -> None:
        ...
        try:
            ...
            self.console.print(f"[red]Error occurred while processing the deposit. Please contact support.[/red]")
    ...
    def _view_portfolios(self, username: str) -> None:
        ...
        try:
            ...
            if not portfolios:
                self.console.print("[yellow]No portfolios found. Please create a portfolio to proceed.[/yellow]")
                return
    ...
    def _create_portfolio(self, username: str) -> None:
        ...
        try:
            ...
            if new_portfolio:
                ...
                self.console.print("[red]Failed to create portfolio. Ensure all fields are correctly filled and try again.[/red]")
        except Exception as e:
            self.console.print(f"[red]Error occurred while creating the portfolio. Please contact support.[/red]")
    ...
    def _marketplace_menu(self, username: str) -> None:
        ...
        while True:
            self.print_menu("Marketplace", ["View Securities", "Buy Security", "Sell Security", "Back to Main Menu"])
            choice = self.prompt_choice(4, "Choose an option")
            if choice == 0:
                continue
            if choice == 4:
    ...
    def _view_securities(self) -> None:
        ...
        try:
            ...
            if not securities:
                self.console.print("[yellow]No tickers found in the marketplace. Please add tickers to proceed.[/yellow]")
                return
    ...
    def _sell_security(self, username: str) -> None:
        ...
        try:
            ...
            self.console.print(f"[red]Unable to sell {symbol}: {ve}[/red]")
        except Exception as e:
