...
# Username: admin, Password: password263
_admin = User(first_name="Admin", last_name="User", username="admin", password="password263", balance=0.0)
users[_admin.username] = _admin

#Tickers
securities = {
    "AAPL": Security(ticker="AAPL", issuer="Apple Inc.", price=150.00),
    "MSFT": Security(ticker="MSFT", issuer="Microsoft Corp.", price=300.00),
    "GOOGL": Security(ticker="GOOGL", issuer="Alphabet Inc.", price=2800.00),
    "AMZN": Security(ticker="AMZN", issuer="Amazon.com Inc.", price=3400.00),
    "TSLA": Security(ticker="TSLA", issuer="Tesla Inc.", price=800.00),
}
...
def seed_initial_data() -> None:
    ...
    if "admin" not in users:
        try:
            admin = User(first_name="Admin", last_name="User", username="admin", password="password263", balance=0.0)
    ...
    default_securities = {
        ...
        "GOOGL": Security(ticker="GOOGL", issuer="Alphabet Inc.", price=2800.0),
        "AMZN": Security(ticker="AMZN", issuer="Amazon.com Inc.", price=3400.0),
        "TSLA": Security(ticker="TSLA", issuer="Tesla Inc.", price=800.0),
    }
